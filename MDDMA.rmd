...
makeGRangesFromGTF(
  Poecilia_reticulata.Guppy_female_1.0_MT.103.gtf,
  level = c("ensembl exon"),
  ignoreTxVersion = TRUE,
  .checkAgainstTxDb = FALSE
)

makeGRangesFromGFF(
  Poecilia_reticulata.Guppy_female_1.0_MT.dna_sm.toplevel_out.gff
  level = c("cpgplot sequence_feature"),
  ignoreTxVersion = TRUE,
  .checkAgainstTxDb = FALSE
)
