...
grnlil <- as.list(myfiles2[c(grep("Green",myfiles2) , grep("Lilac",myfiles2))])
grnlil

myobj <-  methRead(grnlil,
           sample.id = list("green1","green2","green3","lilac1","lilac2","lilac3"),
           assembly = "hg19",
...
saveRDS(object=myDiff,file="GvL_mydiff.rds",compress="gzip")
...
# save object for later
saveRDS(object=myDiff,file="GvL_tiles_mydiff.rds",compress="gzip")
