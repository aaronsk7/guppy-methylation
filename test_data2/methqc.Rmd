...
#Create additional collumns to work out percentage of duplicate reads and percentage of unique reads
...
Here we are creating a bar chart which displays the average insert length for each sample
